...
export const NPCS = [
  // ===== Old Market =========================================================
  {
    ...
    home: { x: -42, z: 15.3 },
    schedule: [
      { from: 0,  to: 6,  at: { x: -42, z: 15.3 }, what: 'sleep' },
      { from: 6,  to: 8,  at: { x: -37, z: 10.8 }, what: 'walk' },
      { from: 8,  to: 12, at: { x: -41, z: 14.2 }, what: 'cook' },
      { from: 12, to: 13, at: { x: -28, z: 4 },  what: 'walk' },
      { from: 13, to: 19, at: { x: -41, z: 14.2 }, what: 'cook' },
      { from: 19, to: 22, at: { x: -42, z: 15.3 }, what: 'home' },
      { from: 22, to: 24, at: { x: -42, z: 15.3 }, what: 'sleep' },
    ],
  ...
  },
  {
    ...
    home: { x: -46, z: 18.7 },
    schedule: [
      { from: 0,  to: 5,  at: { x: -46, z: 18.7 }, what: 'sleep' },
      { from: 5,  to: 7,  at: { x: -27, z: 9.7 }, what: 'walk' },
      { from: 7,  to: 18, at: { x: -27, z: 9.7 }, what: 'stall' },
      { from: 18, to: 20, at: { x: -33, z: 6.3 },  what: 'walk' },
      { from: 20, to: 24, at: { x: -46, z: 18.7 }, what: 'home' },
    ],
  ...
  },
  {
    ...
    home: { x: -50, z: -9.6 },
    schedule: [
      { from: 0,  to: 6,  at: { x: -50, z: -9.6 }, what: 'sleep' },
      { from: 6,  to: 8,  at: { x: -21, z: -1.7 },   what: 'walk' },
      { from: 8,  to: 19, at: { x: -21, z: -1.7 },   what: 'shop' },
      { from: 19, to: 21, at: { x: -44, z: -8.4 },  what: 'walk' },
      { from: 21, to: 24, at: { x: -50, z: -9.6 }, what: 'home' },
    ],
  ...
  },
  {
    ...
    home: { x: -44, z: -8.4 },
    schedule: [
      { from: 0,  to: 6,  at: { x: -44, z: -8.4 }, what: 'sleep' },
      { from: 6,  to: 10, at: { x: -44, z: -8.4 }, what: 'cook' },
      { from: 10, to: 17, at: { x: -43, z: -6.2 }, what: 'shop' },
      { from: 17, to: 19, at: { x: -28, z: 2.9 },   what: 'walk' },
      { from: 19, to: 24, at: { x: -44, z: -8.4 }, what: 'home' },
    ],
  ...
  // ===== Fish Harbour =======================================================
  {
    ...
    home: { x: -15.5, z: -38 },
    schedule: [
      { from: 0,  to: 4,  at: { x: -15.5, z: -38 },  what: 'sleep' },
      { from: 4,  to: 9,  at: { x: -10.1, z: -63 }, what: 'dock' },
      { from: 9,  to: 16, at: { x: -2.4, z: -50 }, what: 'stall' },
      { from: 16, to: 19, at: { x: -10.1, z: -63 }, what: 'dock' },
      { from: 19, to: 21, at: { x: 2, z: -40 },  what: 'walk' },
      { from: 21, to: 24, at: { x: -15.5, z: -38 },  what: 'home' },
    ],
  ...
  },
  {
    ...
    home: { x: 22.8, z: -40 },
    schedule: [
      { from: 0,  to: 3,  at: { x: 22.8, z: -40 }, what: 'sleep' },
      { from: 3,  to: 11, at: { x: 16.3, z: -53 }, what: 'stall' },
      { from: 11, to: 14, at: { x: 19.5, z: -49 }, what: 'walk' },
      { from: 14, to: 18, at: { x: 16.3, z: -53 }, what: 'stall' },
      { from: 18, to: 22, at: { x: 22.8, z: -40 }, what: 'home' },
      { from: 22, to: 24, at: { x: 22.8, z: -40 }, what: 'sleep' },
    ],
  ...
  },
  {
    ...
    home: { x: 30.5, z: -49 },
    schedule: [
      { from: 0,  to: 8,  at: { x: 30.5, z: -49 }, what: 'sleep' },
      { from: 8,  to: 12, at: { x: 6.4, z: -52 },  what: 'walk' },
      { from: 12, to: 15, at: { x: -4.6, z: -46 }, what: 'walk' },
      { from: 15, to: 19, at: { x: 17.4, z: -45 }, what: 'walk' },
      { from: 19, to: 22, at: { x: 30.5, z: -49 }, what: 'home' },
      { from: 22, to: 24, at: { x: 30.5, z: -49 }, what: 'sleep' },
    ],
    favorite: 'mixed_plate',
    greeting: [
  ...
  // ===== Downtown ===========================================================
  {
    ...
    home: { x: 51, z: 28 },
    schedule: [
      { from: 0,  to: 6,  at: { x: 51, z: 28 }, what: 'sleep' },
      { from: 6,  to: 8,  at: { x: 46, z: 21 }, what: 'walk' },
      { from: 8,  to: 12, at: { x: 43, z: 14 },  what: 'shop' },
      { from: 12, to: 13, at: { x: 26, z: 4 },  what: 'walk' },
      { from: 13, to: 19, at: { x: 43, z: 14 },  what: 'shop' },
      { from: 19, to: 22, at: { x: 40, z: 5 },  what: 'walk' },
      { from: 22, to: 24, at: { x: 51, z: 28 }, what: 'home' },
    ],
    favorite: 'tuna_nigiri',
    greeting: [
  ...
  },
  {
    ...
    home: { x: 55, z: 19 },
    schedule: [
      { from: 0,  to: 7,  at: { x: 55, z: 19 }, what: 'sleep' },
      { from: 7,  to: 9,  at: { x: 46, z: 12 }, what: 'walk' },
      { from: 9,  to: 20, at: { x: 26, z: 4 },  what: 'shop' },
      { from: 20, to: 22, at: { x: 34, z: 8 },  what: 'walk' },
      { from: 22, to: 24, at: { x: 55, z: 19 }, what: 'home' },
    ],
    favorite: 'cucumber_maki',
    greeting: [
  ...
  },
  {
    ...
    home: { x: 56, z: 32 },
    schedule: [
      { from: 0,  to: 6,  at: { x: 56, z: 32 }, what: 'sleep' },
      { from: 6,  to: 11, at: { x: 33, z: -8 }, what: 'walk' },
      { from: 11, to: 14, at: { x: 42, z: 9 },  what: 'walk' },
      { from: 14, to: 20, at: { x: 33, z: -8 }, what: 'walk' },
      { from: 20, to: 23, at: { x: 50, z: 24 }, what: 'home' },
      { from: 23, to: 24, at: { x: 56, z: 32 }, what: 'sleep' },
    ],
  ...
  // ===== Residential ========================================================
  {
    ...
    home: { x: -10.7, z: 50.2 },
    schedule: [
      { from: 0,  to: 6,  at: { x: -10.7, z: 50.2 }, what: 'sleep' },
      { from: 6,  to: 9,  at: { x: -10.7, z: 50.2 }, what: 'home' },
      { from: 9,  to: 13, at: { x: -1.1, z: 52 },   what: 'walk' },
      { from: 13, to: 17, at: { x: -15, z: 46.6 },  what: 'walk' },
      { from: 17, to: 21, at: { x: -10.7, z: 50.2 }, what: 'cook' },
      { from: 21, to: 24, at: { x: -10.7, z: 50.2 }, what: 'sleep' },
    ],
    favorite: 'salmon_nigiri',
    greeting: [
  ...
  },
  {
    ...
    home: { x: 10.7, z: 58.3 },
    schedule: [
      { from: 0,  to: 5,  at: { x: 10.7, z: 58.3 }, what: 'sleep' },
      { from: 5,  to: 8,  at: { x: 12.9, z: 55.6 }, what: 'walk' },
      { from: 8,  to: 12, at: { x: 10.7, z: 58.3 }, what: 'home' },
      { from: 12, to: 16, at: { x: 3.2, z: 53.8 }, what: 'walk' },
      { from: 16, to: 20, at: { x: 10.7, z: 58.3 }, what: 'cook' },
      { from: 20, to: 24, at: { x: 10.7, z: 58.3 }, what: 'sleep' },
    ],
    favorite: 'tamago_nigiri',
    greeting: [
  ...
  },
  {
    ...
    home: { x: -19.3, z: 55.6 },
    schedule: [
      { from: 0,  to: 7,  at: { x: -19.3, z: 55.6 }, what: 'sleep' },
      { from: 7,  to: 8,  at: { x: -19.3, z: 55.6 }, what: 'home' },
      { from: 8,  to: 15, at: { x: -12.9, z: 59.2 }, what: 'walk' },
      { from: 15, to: 19, at: { x: -1.1, z: 62.8 },   what: 'walk' },
      { from: 19, to: 21, at: { x: -19.3, z: 55.6 }, what: 'home' },
      { from: 21, to: 24, at: { x: -19.3, z: 55.6 }, what: 'sleep' },
    ],
    favorite: 'cucumber_maki',
    greeting: [
  ...
  },
  {
    ...
    home: { x: 22.5, z: 46.6 },
    schedule: [
      { from: 0,  to: 6,  at: { x: 22.5, z: 46.6 }, what: 'sleep' },
      { from: 6,  to: 9,  at: { x: 22.5, z: 46.6 }, what: 'home' },
      { from: 9,  to: 17, at: { x: 18.2, z: 50.2 }, what: 'shop' },
      { from: 17, to: 20, at: { x: 9.6, z: 52 }, what: 'walk' },
      { from: 20, to: 23, at: { x: 22.5, z: 46.6 }, what: 'home' },
      { from: 23, to: 24, at: { x: 22.5, z: 46.6 }, what: 'sleep' },
    ],
    favorite: 'mixed_plate',
    greeting: [
  ...
  // ===== Neon Food Street ===================================================
  {
    ...
    home: { x: 48, z: -42.8 },
    schedule: [
      { from: 0,  to: 3,  at: { x: 44, z: -38.1 },  what: 'cook' },
      { from: 3,  to: 5,  at: { x: 48, z: -42.8 }, what: 'home' },
      { from: 5,  to: 13, at: { x: 48, z: -42.8 }, what: 'sleep' },
      { from: 13, to: 16, at: { x: 46, z: -36.2 },  what: 'walk' },
      { from: 16, to: 19, at: { x: 44, z: -38.1 },  what: 'cook' },
      { from: 19, to: 24, at: { x: 44, z: -38.1 },  what: 'cook' },
    ],
    favorite: 'chefs_roll',
    greeting: [
  ...
  },
  {
    ...
    home: { x: 35, z: -49.5 },
    schedule: [
      { from: 0,  to: 4,  at: { x: 37, z: -45.7 }, what: 'cook' },
      { from: 4,  to: 12, at: { x: 35, z: -49.5 }, what: 'sleep' },
      { from: 12, to: 15, at: { x: 35, z: -49.5 }, what: 'home' },
      { from: 15, to: 18, at: { x: 40, z: -41.9 }, what: 'walk' },
      { from: 18, to: 24, at: { x: 37, z: -45.7 }, what: 'cook' },
    ],
  ...
  },
  {
    ...
    home: { x: 52, z: -34.3 },
    schedule: [
      { from: 0,  to: 3,  at: { x: 52, z: -34.3 }, what: 'stall' },
      { from: 3,  to: 6,  at: { x: 52, z: -34.3 }, what: 'home' },
      { from: 6,  to: 14, at: { x: 52, z: -34.3 }, what: 'sleep' },
      { from: 14, to: 17, at: { x: 55, z: -30.5 }, what: 'walk' },
      { from: 17, to: 24, at: { x: 52, z: -34.3 }, what: 'stall' },
    ],
